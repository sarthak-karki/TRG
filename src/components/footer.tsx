...
const Footer: FunctionComponent = () => {
  return (
    <>
      <footer className="bg-white text-indigo-900 pt-12 border-t-2 border-gray-200">
          ...
          <div>
            ...
            <div className="md:flex mb-14">
              <div className="pb-0 md:basis-4/12 md:border-b-0 border-b-2 border-solid pt-6 box-border">
                <div className="text-indigo-900 font-sans text-base font-bold leading-normal">
                  The Rising Gurkhas
                </div>
                        ...
                        >
                          ...
                          <div className="p-1">
                            <svg
                              ...
                              height="28"
                              viewBox="0 0 50 50"
                              className="fill-indigo-900 hover:fill-stone-500"
                            >
              ...
              <div className="border-l-2 border-r-2 border-solid border-slate-300 pt-3 pl-9 relative w-1/4 border-box">
                <nav className="box-border">
                  <ul className="list-none m-0 p-0">
                    <li className="list-none mb-4">
                      <a
                        href="#"
                        className="text-indigo-900 font-sans text-base font-semibold leading-normal"
                        rel="noreferrer"
                      >
                        Contact Us
                      </a>
              ...
              <div className="md:ml-9 md:p-0 p-14 md:basis-2/5 border-box md:flex">
                <div className="mr-5">
                  <div className="min-w-20 w-20 bg-white">
        ...
        <div className="bg-gray-100 font-sans text-sm md:p-0 p-14 leading-snug border-t-2 border-gray-200">
          <div className="md:flex lg:mx-20 md:mx-14 max-w-7xl">
            <div className="w-full">
              <div className="lg:p-3 pb-6 border-solid border-b border-gray-300">
                <nav>
                  <ul>
                    <li>
                      <a href="#">
              ...
              <div className="py-6 border-solid border-b border-gray-300 font-sans">
